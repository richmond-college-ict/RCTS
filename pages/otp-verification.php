...
<div class="container w-25" id="box">
    ...
    <form class="form" method="POST" action="../data/otp-verification.php">
        <label for="census_code" class="form-label">Enter OTP Code:</label>
        <input type="text" name="otp" class="form-control" required><br>
        <p style="color: red">OTP has been sent to <?php echo($email); ?></p>
