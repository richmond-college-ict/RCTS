...
if (isset($_SESSION['email'])) {
    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav_content">
            ...
            $sql = 'SELECT id, news_header, news_description, date_time, img_path FROM nextgen ORDER BY date_time';
          ...
          <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
            ...
            <div class="container-fluid">
                <h1 style=" font-family: Share Tech Mono, monospace;"> NextGen'25 Posts</h1><br>
                <button class="btn btn-primary" onclick="location.href='new-nextgen-post.php';">New Post</button>
                <table class="table">
                    <thead>
                        <tr>
                            <th>id</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button type="button" class="btn btn-link"
                                        onclick="location.href='edit-nextgen-post.php?id=<?php echo urlencode($row['id']) ?>';">Edit</button>
                                    <button type="button" class="btn btn-link"
                                        onclick="location.href='../data/delete-nextgen-post.php?id=<?php echo urlencode($row['id']) ?>';">Delete</button>
