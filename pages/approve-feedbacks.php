...
?>
    ...
    <head>
        ...
        <title>Approve Feedbacks - Admin | RCTS</title>
    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav_content">
            ...
            <div class="container-fluid">
                <h1 class="mt-4">Approve Reviews</h1>
                ...
                <table class="table mt-5">
                        ...
                        <tbody>
                        	...
                        	include '../controller/connection.php';
                        		$count = 1;
                        		$sql1 = "SELECT * FROM review_tbl WHERE is_deleted='0' AND is_approved='0' AND year='".date("Y")."' ORDER BY is_approved ASC";
